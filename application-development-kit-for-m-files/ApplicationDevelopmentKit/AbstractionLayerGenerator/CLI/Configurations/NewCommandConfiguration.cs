...
{
	public static class NewCommandConfiguration
	{
		public static void Configure(CommandLineApplication commandLineApp, CommandLineOptions commandLineOptions)
		{
			commandLineApp.Description = "Create a new M-Files VAF Vault Application solution/project.";
			...
			commandLineApp.OnExecute(() => {
				commandLineOptions.Command = new NewCommand(commandLineOptions, projectNameOption.Value(), serverNameOption.Value(), portOption.Value(),
